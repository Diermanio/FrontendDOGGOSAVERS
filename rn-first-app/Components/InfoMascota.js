    ...
    render() {
      ...
      return (
        <ScrollView style={styles.parent}>
            ...
            <Datos perdida={params.perdida} sexo={params.sexo} detalle={params.detalle} raza={params.raza} peso={params.peso} altura={params.altura} edad={params.edad} dueño={params.dueño} tipo={params.tipob} nav={nav}/>
        </ScrollView>
      );
    }
  }
