    ...
    return (
      <View style={styles.parent}>
        <ScrollView style={styles.contenedor}>
            ...
            altura={mascota.altura} edad={mascota.edad_aproximada} detalle={mascota.detalles} id={mascota.id} nav={props.nav} tipob="MASREP" num={3} id={mascota.id}/>)}
        </ScrollView>
        </View>
  );};
...
export default ListaMascotaUsRep;